      ...
      <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
        <div className="px-6 pt-6 2xl:container">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200">
                ...
                <div>
                  ...
                  <div className="mt-2 flex justify-center gap-4">
                    <h3 className="text-3xl font-bold text-white">23,988</h3>
            ...
            <div>
              <div className="h-full py-6 px-6 rounded-xl border border-gray-200">
                <h5 className="text-xl text-white">Earnings</h5>
                <div className="my-8">
                  <h1 className="text-5xl font-bold text-white">$64,500</h1>
            ...
            <div>
              <div className="lg:h-full py-8 px-6 text-white rounded-xl border border-gray-200">
                <svg
