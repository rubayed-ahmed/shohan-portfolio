        ...
        <section className="relative">
          <div className="text-center p-10 py-10">
            ...
            <ul className="social absolute top-[50%] left-[5%] md:left-0">
                <Link to="https://www.linkedin.com/in/rubayed-ahmed-a7b49121b/" target="_blank" 
                ...
                <Link to="https://github.com/rubayed-ahmed" target="_blank" 
                className="my-4 block text-xl md:text-2xl text-rose-500 cursor-pointer hover:text-white transition-all
                 duration-300 ease-linear"><FaGithub/></Link>
                <Link to="https://www.facebook.com/ahmrubayed/" target="_blank" 
                className="my-4 block text-xl md:text-2xl text-rose-500 cursor-pointer hover:text-white transition-all 
